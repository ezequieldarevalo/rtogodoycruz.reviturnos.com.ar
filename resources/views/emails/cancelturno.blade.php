...
<body>
    <div class="cont">
        <span class="dato">Usted acaba de cancelar su turno para realizar la RTO en la planta {{ $turnomail->plant_name }}</span>
        <br/><br/>
        <div class="titulo-general">DETALLES DEL TURNO CANCELADO</div>
        <br/>
